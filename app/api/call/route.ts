...
export async function POST(req: NextRequest) {
  ...
  const body = {
    ...
    assistantOverrides: {
      firstMessage: `Hello, I'm calling on behalf of ${patientName ?? 'a patient'} regarding a prescription ${workflowType === 'status' ? 'status check' : 'refill request'}${medicationName ? ` for ${medicationName}` : ''}. Can you help me with that?`,
      variableValues: {
